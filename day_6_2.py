...
def main(input):
    ...
    while (new_input not in input_history):
        ...
        #print(new_input)
    first_idx = input_history.index(new_input)
    print(str(new_input) + " is the array of investigation. 1st occurrence: " + str(first_idx) + ", total loops: " + str(count) + ". Difference: " + str(count-first_idx))
